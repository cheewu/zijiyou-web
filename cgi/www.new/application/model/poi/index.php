...
$geo = (!empty($poi['center']) && (!empty($poi['center'][0]) || !empty($poi['center'][1]))) 
			? array('lt' => $poi['center'][0], 'lg' => $poi['center'][1]) : null;
...
$query = array('regionId' => new MongoID($poi['regionId']), 'category' => 'attraction');
...
$wiki = get_wiki_content($poi['wikititle']);
